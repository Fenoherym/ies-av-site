...
<div class="w-75 ml-5 pt-5">
        ...
        @endif
    <form class="mt-3" method="post" action="{{ route('admin.etudiants.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control @error('numInscription') is-invalid @enderror" id="numInscription" name="numInscription">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="date" class="form-control @error('datebirth') is-invalid @enderror" id="datebirth" name="datebirth">
                @error('datebirth')
                    <div class="alert alert-danger mt-3">{{ $message }}</div>
                @enderror
            </div>
