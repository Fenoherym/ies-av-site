...
<div class="w-75 ml-5 pt-5">
        ...
        @endif
    <form class="mt-3" method="post" action="{{ route('admin.filiere.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="form-group row">
            <label for="name" class="col-sm-2 col-form-label">Mention: </label>
            <div class="col-sm-10">
          ...
          <div class="form-group row">
            <label for="category" class="col-sm-2 col-form-label">Filiere Categorie: </label>
            <div class="col-sm-10">
