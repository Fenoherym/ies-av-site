...
<div class="w-75 ml-5 pt-5">
        ...
        @endif
    <form class="mt-3" method="post" action="{{ route('admin.enseignant.store') }}" enctype="multipart/form-data">
        @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="isChef" id="flexCheckDisabled">
